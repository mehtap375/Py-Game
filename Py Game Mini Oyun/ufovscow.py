...
class Ufo:
	def __init__(self, Inek, UfoResim, canvas):
		...
		self.textSkor 	= self.canvas.create_text(610, 30, text="Skor : 0", font=("Arial", 16), fill="purple")
		self.textHiz	= self.canvas.create_text(510, 30, text="Hız : 0", font=("Arial", 16), fill="purple")
	...
	def Kaybettin(self):
		...
		self.textid = self.canvas.create_text(350, 150, text="Kaybettin", font=("Arial", 25), fill="purple") 
